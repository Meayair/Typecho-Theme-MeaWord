...
<link rel='stylesheet' id='stylecss-css' href='<?php $this->options->themeUrl('assets/css/style.css'); ?>' type='text/css' media='all' />
<!-- <link rel='stylesheet' id='stylecss-css' href='<?php $this->options->themeUrl('assets/css/comments.css'); ?>' type='text/css' media='all' /> -->
			...
			<div class="top_right">
				<nav class="header-menu">
                    <ul class="header-menu-ul">
                        <li id="menu-item-1504" class="menu-item menu-item-type-custom menu-item-object-custom <?php if($this->is('index')): ?>current-menu-item<?php endif; ?> current_page_item menu-item-home"><a href="<?php $this->options->siteUrl(); ?>" aria-current="page">首页</a></li>
